...
| **Frontend**     | **[React: User Directory](https://github.com/vertigo1919/learning-journal/tree/main/northcoders/4_frontend/2-React/user-directory)** | `useEffect` (Dependency Arrays), `useState`, Async Data Fetching, Error Handling, Loading States, CSS Grid. [Live Demo 🚀](https://nc-react-user-directory.netlify.app/)               |
